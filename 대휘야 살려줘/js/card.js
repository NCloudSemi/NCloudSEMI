$(()=>{
    ...
    function loadMorePosts(initial = false) {
        ...
        for (let i = 0; i < postsToLoad; i++) {
            ...
            if (postType === 'photo') {
                post.innerHTML = `<img src="https://picsum.photos/1080?random=0" alt="Post Image">`;
            } else {
                post.innerHTML = `<video src="https://www.w3schools.com/html/mov_bbb.mp4" controls></video>`;
            }

            document.getElementById('content-main').insertBefore(post, document.getElementById('scroll-anchor'));
            // postCount++;
        }
    }
    ...
    */
    ...
    function openCreatePostContentModal() {
        ...
        document.getElementById('modal-create-post-content').style.display = 'block';
    }
    ...
    */
    ...
    function closeEditPostModal() {
        document.getElementById('modal-edit-post').style.display = 'none';
    }
    ...
    */
    ...
    function closeEditPostModal() {
        ...
        document.getElementById('container-content').style.display = 'flex';
    }
